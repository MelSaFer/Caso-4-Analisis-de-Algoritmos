...
int main() {
    ...
    //1. Chromosomatic representation
    // cromodistribution distribution[DISTRIBUTION_SIZE] = {
    //     {0, 0, 90, 90, 1, 2, 1, 0.0, 0.5, 200, 1000},
    //     {0, 0, 90, 90, 1, 3, 1, 0.5, 0.8, 400, 1000},
    //     {0, 0, 90, 90, 1, 3, 1, 0.8, 1.0, 400, 1000}
    // };

    // vector<cromodistribution> geneticTable;
    // //generateDistrubucionTable(geneticTable);
